...
1.  Setup
2.  Introduction to R
3.  Introduction to DHS survey data
4.  Work with DHS GPS coordinates
5.  Work with CHIRTS temperature data
6.  Aggregate spatial data
6.  Link climate data and DHS surveys
7.  Build a multilevel model to assess climate impacts
